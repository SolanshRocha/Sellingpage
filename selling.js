...
var products = [
    ...
    name : 'coat',
    price : 390+"$",
    url : 'images/coat.jpeg',
    like :  true
    },
    {
    name : 'jeans',
    price : 100+"$",
    url : 'images/jeans.jpeg',
    like :  false
    },
];

for (var i = 0; i < products.length; i++){
    document.getElementById("container").insertAdjacentHTML('afterbegin','<div id = "produit'+i+'">'+'</div>');
    document.getElementById("produit"+i).innerHTML='<header id="name'+i+'">'+products[i].name+'<b>'+products[i].price+
    '</b>'+'<img width=300px height=300px src="'+products[i].url+'">'+'<button class ="boutton">Buy</button>'+'</header>';
    //document.getElementById("produit"+i).insertAdjacentHTML('afterbegin', '<img src="'+products[i].url+'>');
